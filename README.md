## 👋 Привет, меня зовут Зуфар Шагиев

Меня интересуют направления, связанные с анализом данных, Data Science и Deep Learning.

В своей работе я использую инструменты DS и классического ML (регрессия, деревья решений, бустинги) для детектирования кредитного мошенничества / потенциальной просроченной задолженности, применяю методы NLP и MLE для повышения эффективности аналитики (в т.ч. эмбеддинги, суммаризацию и классификацию  текста, анализ тональности, векторные БД, RAG, LLM). 
